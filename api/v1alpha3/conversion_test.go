...
import (
	...
	"github.com/spectrocloud/sample-bootstrap-provider/api/v1alpha4"
	kubeadmbootstrapv1alpha4 "github.com/spectrocloud/sample-bootstrap-provider/api/v1alpha4"
	"github.com/spectrocloud/sample-bootstrap-provider/types/v1beta1"
	kubeadmv1beta1 "github.com/spectrocloud/sample-bootstrap-provider/types/v1beta1"
