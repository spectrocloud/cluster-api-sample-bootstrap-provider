...
//
// +k8s:conversion-gen=github.com/spectrocloud/sample-bootstrap-provider/api/v1alpha4
// +k8s:deepcopy-gen=package
package v1beta2 // import "github.com/spectrocloud/sample-bootstrap-provider/types/v1beta2"
